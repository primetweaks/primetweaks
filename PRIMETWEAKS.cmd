...
echo.                                   %p%░░░╚═╝░░░╚═╝░░╚══════╝╚══════╝░╚════╝░░╚════╝░╚═╝░░░░░╚═╝╚══════╝░
echo.                 %b%"══════════════════════════════════════════════════════════════════════════════════════════════════"%w%                                                                                                  
echo.                                %w%  Made by PRIMETWEAKS® 2024 %b%║%w% Version 3.0 %b%║%w% updated 4th of march 2024           
echo.                                  FORTNITE TWEAKS ARE APPLIED WITH THIS.                                                                  
echo.
...
cls
chcp 437 >nul 2>&1
powershell -NoProfile Expand-Archive '%temp%\nvidiaProfileInspector.zip' -DestinationPath 'C:\exm\' >nul 2>&1 
chcp 65001 >nul 2>&1
cls
echo. %b% 
echo. ╔═════════════════════════════╗
...
echo. ╚═════════════════════════════╝
echo.
curl -g -k -L -# -o "C:\exm\Exm Free Power Plan V3.pow" "https://www.dropbox.com/scl/fi/dd7wjv2j5plkzdfwudy00/EXM-Free-Power-Plan-V3.pow?rlkey=05no4032mcfi1sug10fq8qko0&dl=0"
...
echo. ╚═════════════════════════════╝
echo.
curl -g -k -L -# -o "C:\exm\Exm Free Settings V5.nip" "https://www.dropbox.com/scl/fi/1ruuynh8j7s0ig92m2i0x/EXM-NVPI-Settings-V5.nip?rlkey=3mvl5bbaafhoguubhbbqmxef9&dl=0" 
timeout /t 1 /nobreak > NUL
cls
echo. %b% 
echo. ╔═════════════════════════════╗
...
echo. ╚═════════════════════════════╝
echo.
curl -g -k -L -# -o "C:\exm\Autoruns.exe" "https://www.dropbox.com/scl/fi/w90nzg8f8scbo4k985m4x/Auto-Runs-APP.exe?rlkey=csxjk1uukpbyatv3isr85sm0t&dl=0"
timeout /t 1 /nobreak > NUL
cls
echo. %b% 
echo. ╔═════════════════════════════╗
...
echo. ╚═════════════════════════════╝
echo.
curl -g -k -L -# -o "C:\exm\Windows Update Blocker.exe" "https://www.dropbox.com/scl/fi/cb116g9tfua8iec0czxrw/Windows-Update-Blocker-APP.exe?rlkey=js1drqmwbdt2v2p152sznum5d&dl=0"
timeout /t 1 /nobreak > NUL
cls
goto menu
...
echo.       %w%                                                                                                                                          
echo.       %w%                                                                                                                                                                           
echo.       %w%                                  Made by JAZEY TWEAKS® 2024 %b%║%w% Discord.gg/exm %b%║%w% Updated 4th March                                         
echo.       %w%                                                                                                                  
echo.       %b%"═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"
...
if /i %input% == W start https://whop.com/prime-tweaks/
...
:w6
cls
start C:\exm\Windows Update Blocker.exe
echo.
echo.
echo.
echo.                                              %b%"═══════════════════════════════════════════════════════"
...
powercfg -import "C:\exm\Exm Free Power Plan V3.pow"
powercfg.cpl
timeout /t 1 /nobreak > NUL
echo.
echo.
...
start "" /wait "C:\exm\NvidiaProfileInspector.exe" "C:\exm\Exm Free Settings V5.nip" 
