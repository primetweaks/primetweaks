...
:: discord server
start https://discord.gg/zfWTzjgr
...
echo.                                                            
echo.      %p%║════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%p%║      
echo.      %p%║                                                  Version 3.0 - By Jazey (https://discord.gg/rmzKgBxSCn)                                                     %p%║
echo.      %p%║════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%p%║
echo.      %p%║                                                                                                                                                %p%║
echo.      %p%║                                                         [1] Ultimate Optimization                                                              %p%║
echo.      %p%║                                                         [2] [ NEW ] Fortnite Tweaks                                                            %p%║
echo.      %p%║                                                         [3] SvhHost Ram Values                                                                 %p%║
echo.      %p%║                                                         [4] Backup/Restore point                                                                p%║
echo.      %p%║════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%p%║
echo.      %p%║                                                                                                                                                %p%║
echo.      %p%║ DISCLAIMER: If this Product was not bought via jazeynugget.tweaks than you were SCAMMED and could have a rat/virus from running the file         %p%║
echo.      %p%║                                                                                                                                                %p%║
echo.      %p%╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%p%╝
echo.                                                                                                                                                   
set /p input=: 
...
fsutil behavior query memoryusage
fsutil behavior set memoryusage 2
echo. %y%[] %z% 8000+ Tweaks have been applied successfully
